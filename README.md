...
| Virtualization simulation | Built and tested on Wokwi (link in docs/) |
...
Wokwi project link: see docs/wokwi-link.md

## Repo structure

firmware-telemetry-core/
├── README.md
├── firmware_telemetry_core.ino
└── docs/
    ├── wokwi-link.md
    ├── simulation-overview.jpg
    └── serial-monitor-output.jpg# getintern-week1-firmware
